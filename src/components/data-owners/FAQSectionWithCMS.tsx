...
import { dataOwnersFAQQuery } from "@/sanity/lib/queries";
...
export default function FAQSectionWithCMS() {
  // Fetch FAQ data from Sanity
  const { data: faqData } = useSanityData<FAQData>(dataOwnersFAQQuery);

  // Fallback to hardcoded content
  const faqs = faqData || {
    headline: "Common questions",
    subheadline: "Everything you need to know about Precise's data collaboration platform",
    items: [
      {
