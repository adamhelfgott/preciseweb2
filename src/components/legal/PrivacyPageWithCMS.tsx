...
import { privacyPolicyQuery } from "@/lib/sanity/queries/legal";
import LegalPageWithCMS from "@/components/legal/LegalPageWithCMS";
import Link from "next/link";

// Fallback content for privacy policy
      ...
      content: [
        {
          ...
          children: [
            {
              _type: 'span',
              text: 'Precise.ai ("Precise," "we," "our," or "us") is committed to protecting your privacy. This Privacy Policy explains how we collect, use, and safeguard information when you use our federated intelligence platform.'
            }
          ]
        },
        {
          ...
          children: [
            {
              _type: 'span',
              text: 'Key Principle: We are a privacy-preserving infrastructure provider. We do not collect, store, or have access to the underlying data that flows through our federated queries.',
              marks: ['strong']
            }
          ]
        }
      ...
      content: [
        {
          ...
          children: [
            {
              _type: 'span',
              text: 'Precise acts as a data processor, not a data controller or data broker.',
              marks: ['strong']
            }
          ]
        },
        ...
        },
        {
          ...
          children: [
            {
              _type: 'span',
              text: 'We process data only on behalf of and under the instructions of data controllers'
            }
          ]
        },
        {
          ...
          children: [
            {
              _type: 'span',
              text: 'We do not determine the purposes or means of data processing'
            }
          ]
        },
        {
          ...
          children: [
            {
              _type: 'span',
              text: 'We do not sell, rent, or trade any data'
            }
          ]
        },
        {
          ...
          children: [
            {
              _type: 'span',
              text: 'We enable privacy-preserving queries without accessing raw data'
            }
          ]
        }
      ]
...
export default function PrivacyPageWithCMS() {
  const { data, loading, error } = useSanityData(privacyPolicyQuery);
