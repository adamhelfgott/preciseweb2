      ...
      <div className="container">
        <div className="flex items-center justify-between h-16 md:h-20">
          ...
          <div className="hidden lg:flex items-center gap-6">
            {links.map((link) => (
              <Link
                key={link.href}
                href={link.href}
                className="text-medium-gray hover:text-dark-gray transition-colors duration-200 whitespace-nowrap"
              >
                {link.label}
              </Link>
            ))}
          ...
          <button
            ...
            className="xl:hidden p-2 text-dark-gray hover:text-brand-green transition-colors"
          >
        ...
        {/* Mobile Menu */}
        {isMobileMenuOpen && (
          <div className="xl:hidden absolute top-full left-0 right-0 bg-white border-t border-silk-gray shadow-lg">
